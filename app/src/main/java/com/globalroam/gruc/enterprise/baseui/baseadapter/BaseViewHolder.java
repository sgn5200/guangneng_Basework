package com.globalroam.gruc.enterprise.baseui.baseadapter;
...
import com.globalroam.gruc.enterprise.utils.DrawableUtils;
...
public class BaseViewHolder {
    ...
    public BaseViewHolder setNormalImgPath(int viewId, String path) {
        ImageView iv = getView(viewId);
        DrawableUtils.displayNormalImgOnNet(iv, path, 0);
        return this;
    }

    public BaseViewHolder setNormalImgPath(int viewId, String path,int resource) {
        ImageView iv = getView(viewId);
        DrawableUtils.displayNormalImgOnNet(iv, path, resource);
        return this;
    }
