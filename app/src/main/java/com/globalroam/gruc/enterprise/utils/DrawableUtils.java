...
public class DrawableUtils {
    ...
    public static DisplayImageOptions DISPLAY_OPTIONS =
            new DisplayImageOptions.Builder().showImageForEmptyUri(R.mipmap.ic_launcher)
     ...
     * @param url
     */
    public static void displayNormalImgOnNet(final ImageView img, final String url,int resourseId) {
        if (TextUtils.isEmpty(url)) {
    ...
    public static void FadeInDisplay(ImageView imageView, Bitmap bitmap) {
        final TransitionDrawable transitionDrawable =
                new TransitionDrawable(new Drawable[]{new ColorDrawable(0x888888),
